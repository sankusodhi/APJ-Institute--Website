...
code = code.replace(/cyan-300/g, '[#5984b8]'); // light variant for text
...
// Light cyan backgrounds -> slate backgrounds or #1e3a5f/10
code = code.replace(/cyan-50/g, '[#1e3a5f]/5');
code = code.replace(/cyan-100/g, '[#1e3a5f]/10');
code = code.replace(/cyan-200/g, '[#1e3a5f]/20');

// Blue replacements (since some parts use blue-500 and blue-600)
...
// Special fixes for gradients to make them solid or nice
